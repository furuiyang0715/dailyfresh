...
TEST_MYSQL_PASSWD = env.get("TEST_MYSQL_PASSWD", cf.get('test', 'TEST_MYSQL_PASSWD'))
...
if LOCAL:
    ...
    SPIDER_MYSQL_PASSWORD = TEST_MYSQL_PASSWD
...
if LOCAL:
    ...
    PRODUCT_MYSQL_PASSWORD = TEST_MYSQL_PASSWD
